export const DEFAULT_SITE_PROFILE = {
  ...
  heroSubtitle:
    'AI Research Scientist | PhD in AI in Medicine | Medical Imaging, Clinical LLMs & Trustworthy Healthcare AI',
  heroBody:
  ...
  skillsSubtitle:
    'Medical Imaging AI, Clinical LLMs, Multimodal Learning, Trustworthy AI, and Clinical Decision Support',
  aboutText:
  ...
  cvFileUrl: '/CV_03_26.pdf',
  skills: [
    { name: 'Python', level: 95 },
    { name: 'Machine Learning & Deep Learning', level: 95 },
    { name: 'Medical Imaging AI', level: 92 },
    { name: 'PyTorch / TensorFlow', level: 90 },
    { name: 'Computer Vision (CNNs, Transformers, Vision-Language Models)', level: 90 },
    { name: 'Clinical LLMs & RAG Systems', level: 88 },
    { name: 'Multimodal AI', level: 85 },
    { name: 'Clinical Decision Support Systems', level: 85 },
    { name: 'Explainable & Trustworthy AI', level: 82 }
  ],
